$(function () {
    $.ajax({
        ...
        success:function(data){
            ...
            var context = "<tbody><tr><td>"+data["avg1"]+"</td> <td>"+data["avg3"]+"</td><td>"+data["variance1"]+"</td><td>"+data["variance3"]+"</td> <td>"+data["avg2"]+"</td> <td>"+data["avg4"]+"</td> <td>"+data["variance2"]+"</td> <td>"+data["variance4"]+"</td> </tr> </tbody>";
            $("#tb").append(context);
