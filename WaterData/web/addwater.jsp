...
<div class="left-side sticky-left-side">
    ...
    <div class="left-side-inner">
        ...
        <ul class="nav nav-pills nav-stacked custom-nav">
            ...
            <li class="menu-list nav-active"><a href="#"><i class="icon-grid"></i> <span>A设备数据处理</span></a>
                <ul class="sub-menu-list">
                    <li class="active"><a href="table-responsive.html">数据分析</a></li>
            ...
            <li class="menu-list"><a href="waterdata.html"><i class="icon-lock"></i> <span>B设备数据处理</span></a>
                <ul class="sub-menu-list">
...
<div class="main-content" >
    ...
    <div class="row">
        ...
        <div class="col-md-5">
            <div class="white-box">
                <h2 class="header-title">水印嵌入</h2>
                <form action="DataProcess" method="get">
                    <div class="form-group">
                        <label>水印信息</label>
                        <input class="form-control"  placeholder="Enter data" name="name">
                    </div>
                    <div class="form-group">
                        <label>秘钥</label>
                ...
                <div class="col-md-5">
                    <div class="panel panel-default" style="height: 280px">
                        ...
                        <div class="panel-body">
                            <h4 font style="font-family:楷体">加密位数：${length}位</h4><br>
                            <h4 font style="font-family:楷体">秘钥：${password}</h4>
                        </div>
                    </div>
                </div>
        <div class="col-md-1">
